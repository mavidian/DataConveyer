...
namespace Mavidian.DataConveyer.Entities.KeyVal
{
   ...
   public interface IUntypedRecord : IRecordBase
   {
      ...
      IItem AddItem(string key, string value);
      /// <summary>
      ...
      IItem GetItemClone(IItem item, string value);
      /// <summary>
      ...
      IUntypedRecord CreateEmptyX12Segment(string name, int elementCount);
      /// <summary>
      ...
      IUntypedRecord CreateFilledX12Segment(string contents, char fieldDelimiter = '\0');
   }
}
