...
namespace DataConveyer_tests.Entities.KeyVal
{
   ...
   public class IRecord_tests
   {
      ...
      {
         _config = new OrchestratorConfig() { AllowTransformToAlterFields = true, PropertyBinEntities = PropertyBinAttachedTo.Records };
      ...
      public void IndexersEtc_SimpleValues_CorrectData()
      {
         ...
         rec.Items[3].Value.Should().Be(184);
      ...
      public void IndexerSet_SimpleValues_ValuesAssigned()
      {
         ...
         //act
         rec[0] = "new719..";
         rec[3] = 1000.0f; //OK to pass float w/o fractional part
         ...
         rec[1].Should().Be("blahblah");
         rec[2].Should().BeOfType(typeof(DateTime));
         rec[2].Should().Be(DateTime.Parse("1/1/1753"));
         rec[3].Should().BeOfType(typeof(int));
      ...
      public void IndexerSet_BadValues_DefaultValuesAssigned()
      {
         ...
         //act
         rec[3] = 1000.05f;  //float won't get rounded
         rec["D_date"] = "notDate";
         ...
         rec[1].Should().Be("blahblah");
         rec[2].Should().BeOfType(typeof(DateTime));
         rec[2].Should().Be(default(DateTime));
         rec[3].Should().BeOfType(typeof(int));
         rec[3].Should().Be(default(int));
      }
      ...
      public void RemoveItem_ExistingKey_RemoveItemAndReturnTrue()
      {
         ...
         rec[1].Should().BeOfType(typeof(string));
         rec[1].Should().Be("blahblah");
         rec[2].Should().BeOfType(typeof(int));
         rec[2].Should().Be(184);
      }
      ...
      public void AddItem_SampleValue_ReturnAddedItem()
      {
         ...
         rec[3].Should().BeOfType(typeof(int));
         rec[3].Should().Be(184);
         rec[4].Should().BeOfType(typeof(int));
         rec[4].Should().Be(360);
      ...
      [TestMethod]
      public void AddOrReplaceItem_ExistingKeyAndCannotAlterFields_ReplaceAndReturnsTrue()
      {
         //arrange
         _config.AllowTransformToAlterFields = false;  //it was set to true in test Initialize method
         IRecord rec = new KeyValRecord(_items, _recNo, 1, 0, null, null, null, _typeDefs, _config, null, ActionOnDuplicateKey.IgnoreItem);
      ...
      {
         //arrange
         IRecord rec = new KeyValRecord(_items, _recNo, 1, 0, null, new Dictionary<string, object>(), new Dictionary<string, object>(), _typeDefs, _config, null, ActionOnDuplicateKey.IgnoreItem);
